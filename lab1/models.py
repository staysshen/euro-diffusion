class Algorithm:
    ...
    def create_countries(self, lines):
        ...
        self.countries = [self.create_country_from_line(line) for line in lines]
    ...
    def create_empty_world_map (self):
        ...
        x_range = range(max_xh - min_xl + 1)
        y_range = range(max_yh - min_yl + 1)

        return [[None for _ in y_range] for _ in x_range]  # Створення пустої області
